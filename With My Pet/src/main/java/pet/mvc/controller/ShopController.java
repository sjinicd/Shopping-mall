...
import pet.mvc.fileSetting.path;
...
import pet.mvc.shopdomain.Register;
import pet.mvc.shopdomain.Review;
import pet.mvc.shopservice.FileUploadService;
...
public class ShopController {
	...
	private ModelAndView saveFilee(MultipartFile file, Product product,long catgo_code) {
		//파일 이름 변경
	    ...
	    try {
	        ...
	        e.printStackTrace();
	        return new ModelAndView("/shop/category","saveFile",saveFile);
	    }
